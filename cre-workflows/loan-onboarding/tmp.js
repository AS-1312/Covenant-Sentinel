...
var LoanRegistry = [
  {
    inputs: [
      ...
      { internalType: "uint256", name: "reportingFrequency", type: "uint256" },
      { internalType: "string[]", name: "covenantNames", type: "string[]" },
      { internalType: "string[]", name: "metricDefinitions", type: "string[]" },
      { internalType: "uint256[]", name: "thresholds", type: "uint256[]" },
      { internalType: "string[]", name: "thresholdTypes", type: "string[]" },
      { internalType: "string[]", name: "ebitdaAdjustments", type: "string[]" }
    ],
    name: "registerLoan",
    outputs: [],
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "uint256", name: "covenantCount", type: "uint256" },
